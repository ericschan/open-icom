...
public interface BeanInfo {
	...
	public ManagedDependentProxy attachDependentHierarchy(ManagedObjectProxy parentProxy, 
			Persistent dependent, String parentAttributeName);
	
	public void detachHierarchy(ManagedObjectProxy mop);
	
	public void prepareDetachableState(ManagedObjectProxy mop);
	
	public int getClassOrdinal();
	
	public void clearObject(Persistent pojo);
