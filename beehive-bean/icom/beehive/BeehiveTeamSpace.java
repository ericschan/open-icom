...
@XmlType(name="BeehiveTeamSpace", namespace="http://docs.oasis-open.org/ns/icom/beehive/201008")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(namespace="http://docs.oasis-open.org/ns/icom/beehive/201008")
public class BeehiveTeamSpace extends BeehiveSpace implements Addressable {
	
	private static final long serialVersionUID = 1L;
	
	/**
	 * @$clientQualifier defaultAnnouncementForum :
	 * Forum
	 * @associates Forum
	 */
	Forum defaultAnnouncementForum;
	
	/**
	 * @$clientQualifier defaultDiscussionForum :
	 * Forum
	 * @associates Forum
	 */
	Forum defaultDiscussionForum;
	...
	public BeehiveTeamSpace(Id id, Community parent, Date createdOn) {
		super(id, parent, createdOn);
	}

	private BeehiveTeamSpace(Community parent, Date createdOn) {
		super(parent, createdOn);
	}
	
	public BeehiveTeamSpace(Community parent, Actor createdBy, Date createdOn) {
        this(parent, createdOn);
        if (createdBy instanceof BeehiveOrganizationUser) {
            BeehiveOrganizationUser user = (BeehiveOrganizationUser) createdBy;
            user.addAccessibleSpace(this);
        }
    }
	...
	public void delete() {
	    Actor createdBy = getCreatedBy();
	    if (createdBy instanceof BeehiveOrganizationUser) {
            BeehiveOrganizationUser user = (BeehiveOrganizationUser) createdBy;
            user.removeAccessibleSpace(this);
        }
        super.delete();
    }
