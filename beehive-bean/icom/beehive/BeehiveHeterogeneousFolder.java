...
@XmlType(name="BeehiveHeterogeneousFolder", namespace="http://docs.oasis-open.org/ns/icom/beehive/201008")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(namespace="http://docs.oasis-open.org/ns/icom/beehive/201008")
public class BeehiveHeterogeneousFolder extends HeterogeneousFolder {
	...
	BeehiveHeterogeneousFolder() {
		super();
	}
	
	public BeehiveHeterogeneousFolder(Id id, FolderContainer parent, Date createdOn, Date userCreatedOn) {
		super(id, parent, createdOn, userCreatedOn);
	}
	
	public BeehiveHeterogeneousFolder(FolderContainer parent, Date createdOn, Date userCreatedOn) {
	...
	boolean addCategoryConfiguration(BeehiveCategoryConfiguration categoryConfiguration) throws IllegalConfigurationException {
		...
		if (existingTemplateConfiguration != null && existingTemplateConfiguration.getExtent() == this) {
