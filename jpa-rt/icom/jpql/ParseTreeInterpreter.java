...
public class ParseTreeInterpreter implements ParseTreeVisitor {
	
	ParseTreeContext context;
	QueryContext queryContext;
	
	public ParseTreeInterpreter(ParseTreeContext context, QueryContext queryContext) {
	...
	public Node visitNode(SelectClauseNode node, AbstractNode parent) {
		return queryContext.visitNode(node, parent);
	}
