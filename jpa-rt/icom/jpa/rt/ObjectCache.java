...
/**
 * An object cache interface that micmics the interface for HashTable.
 */
public interface ObjectCache {
     ...
     * @param key the object key
     * @return the cacheable object or null if not found
     */
    ...
    /**
     * @return the collection of cacheable objects
     */
    public Collection<ManagedIdentifiableProxy> values();

    /**
     * associate the cache with the cache monitor
     */
    public void setCacheMonitor(ObjectCacheAbstractMonitor mon);

    /**
     * Get the backup cache
     */
    public ObjectCache getBackupCache();

    /**
     * perform one sweep of the cache for the cache monitor
     */
