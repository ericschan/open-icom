...
public class JtaSynchronizationListener implements Synchronization {
	
	EntityTransaction entityTransaction;
	
	public JtaSynchronizationListener(EntityTransaction entityTransaction) {
	...
	public void afterCompletion(int stat) {
		((JtaResourceManager)entityTransaction).clearJtaSynchronizationListener();
	}
