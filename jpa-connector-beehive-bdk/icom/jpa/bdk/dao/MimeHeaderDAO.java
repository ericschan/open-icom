...
public class MimeHeaderDAO extends BdkAbstractDAO {
	...
	public void copyObjectState(ManagedObjectProxy managedObj, Object bdkMimeHeader, Projection proj) {
		copyObjectState(managedObj.getPojoObject(), (MimeHeader) bdkMimeHeader);
	}
