...
public class UnknownEntityDAO extends EntityDAO {
	
	static UnknownEntityDAO singleton = new UnknownEntityDAO();
	
	public static UnknownEntityDAO getInstance() {
		return singleton;
	}

	protected UnknownEntityDAO() {
	}
