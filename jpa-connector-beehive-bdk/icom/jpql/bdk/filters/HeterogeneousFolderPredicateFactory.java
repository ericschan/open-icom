...
import icom.jpa.bdk.dao.HeterogeneousFolderDAO;
...
public class HeterogeneousFolderPredicateFactory extends FolderPredicateFactory {
	...
	{
		attributeTypeMapper.put(HeterogeneousFolderInfo.Attributes.elements.name().toLowerCase(), Artifact.class);
	}
	...
	public String getResourceType() {
		return HeterogeneousFolderDAO.getInstance().getResourceType();
	}
	
	public String resolveDataAccessStateObjectClassName() {
		return HeterogeneousFolder.class.getSimpleName();
	}
