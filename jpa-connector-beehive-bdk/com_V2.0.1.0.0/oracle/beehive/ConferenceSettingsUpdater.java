 ...
 *         &lt;element name="roleUpdates" type="{http://www.oracle.com/beehive}conferenceRoleUpdater" maxOccurs="unbounded" minOccurs="0"/>
    ...
    extends IdentifiableUpdater
{
    ...
    protected List<ConferenceRoleUpdater> roleUpdates;
    ...
    /**
     * Gets the value of the roleUpdates property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the roleUpdates property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRoleUpdates().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ConferenceRoleUpdater> getRoleUpdates() {
        if (roleUpdates == null) {
            roleUpdates = new ArrayList<ConferenceRoleUpdater>();
        }
        return this.roleUpdates;
    }
