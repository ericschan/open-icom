...
public class BeehiveSystemActorInfo extends ActorInfo {

	static BeehiveSystemActorInfo singleton = new BeehiveSystemActorInfo();
	
	public static BeehiveSystemActorInfo getInstance() {
		return singleton;
	}
	...
	protected BeehiveSystemActorInfo() {	
	}
	
	public int getClassOrdinal() {
		return BeehiveBeanEnumeration.BeehiveSystemActor.ordinal();
	}
