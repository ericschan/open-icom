...
import icom.ql.parser.NodeFactory.TrimSpecification;
...
/** */
public class JPQLParser extends AbstractJPQLParser implements JPQLTokenTypes
 {

    /** The root node of the parsed JPQL query. */
    private Object root;
    ...
    /** TODO check the schema name against BOM classes */
    ...
    /** TODO check the schema name against BOM attributes */
	...
	protected JPQLParser(TokenBuffer tokenBuf, int k) {
	  super(tokenBuf,k);
	  tokenNames = _tokenNames;
	}
	
	public JPQLParser(TokenBuffer tokenBuf) {
	  this(tokenBuf,3);
	}
	
	protected JPQLParser(TokenStream lexer, int k) {
	  super(lexer,k);
	  tokenNames = _tokenNames;
	}
	
	public JPQLParser(TokenStream lexer) {
	  this(lexer,3);
	}
	
	public JPQLParser(ParserSharedInputState state) {
	  super(state,3);
	  tokenNames = _tokenNames;
	}
