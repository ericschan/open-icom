...
/** */
public class JPQLLexer extends persistence.antlr.CharScanner implements JPQLTokenTypes, TokenStream
 {
public JPQLLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public JPQLLexer(Reader in) {
	this(new CharBuffer(in));
}
public JPQLLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public JPQLLexer(LexerSharedInputState state) {
	super(state);
