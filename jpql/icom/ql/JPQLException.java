...
import icom.ql.parser.ExceptionMessageGenerator;
...
/*
 * JPQL parsing and resolution problems will raise this exception
 */
public class JPQLException extends AbstractJPQLException {
    ...
    public Collection<Object> internalExceptions = null;

    /**
    * INTERNAL
    * Only BOM QL can throw and create these exceptions
    */
    ...
    */
     ...
     */
    public Collection<Object> getInternalExceptions() {
        if (internalExceptions == null) {
            setInternalExceptions(new Vector<Object>());
        }
     ...
     */
    public void setInternalExceptions(Collection<Object> theExceptions) {
    ...
    public void printFullStackTrace() {
        if (hasInternalExceptions()) {
            Iterator<Object> exceptions = getInternalExceptions().iterator();
