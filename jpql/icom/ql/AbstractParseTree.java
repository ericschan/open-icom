...
public abstract class AbstractParseTree extends AbstractNode {
    ...
    public void validate(SchemaHelper schemaHelper) {
        validate(context, schemaHelper);
    }
    
    public abstract void validate(ParseTreeContext context, SchemaHelper schemaHelper);
	...
	public abstract JPQLParseTree accept(ParseTreeVisitor visitor, AbstractNode parent);
