...
Represents simple_arithmetic_expression, arithmetic_term, comparison_expression, collection_member_expression
...
public abstract class BinaryOperatorNode extends Node {
    ...
    public void acceptVisitor(ParseTreeVisitor visitor, AbstractNode parent) {
        if (left != null) {
