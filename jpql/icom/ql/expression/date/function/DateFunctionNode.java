 ...
 * holder.
 */
package icom.ql.expression.date.function;
...
Represent a date function: CURRENT_DATE, CURRENT_TIME, CURRENT_TIMESTAMP.
...
public class DateFunctionNode extends FunctionalExpressionNode {
    ...
    public Class getDateFunctionType() {
		return type;
	}

	public void setDateFunctionType(Class type) {
		this.type = type;
	}
