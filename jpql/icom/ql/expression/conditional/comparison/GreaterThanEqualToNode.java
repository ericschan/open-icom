 ...
 * holder.
 */
package icom.ql.expression.conditional.comparison;
...
public class GreaterThanEqualToNode extends ComparisonExpressionNode {
    ...
    public Node accept(ParseTreeVisitor visitor, AbstractNode parent) {
        super.acceptVisitor(visitor, parent);
