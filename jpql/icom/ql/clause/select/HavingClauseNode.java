...
public class HavingClauseNode extends ClauseNode {

    private Node havingExpression = null;

    public Node getHaving() {
        return havingExpression;
    }

    public void setHaving(Node havingExpression) {
        this.havingExpression = havingExpression;
    }
    
	public Node accept(ParseTreeVisitor visitor, AbstractNode parent) {
        if (havingExpression != null) {
        	havingExpression = havingExpression.accept(visitor, this);
        }
