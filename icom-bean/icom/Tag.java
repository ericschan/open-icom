...
@XmlType(name="Tag", namespace="http://docs.oasis-open.org/ns/icom/metadata/201008")
...
public class Tag extends Marker {
	...
	public Tag(Id id, Space space, Date createdOn, Date userCreatedOn) {
		super(id, space, createdOn, userCreatedOn);
	}
	
	public Tag(Space space, Date createdOn, Date userCreatedOn) {
