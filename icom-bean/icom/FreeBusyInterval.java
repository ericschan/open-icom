...
@XmlType(name="FreeBusyInterval", namespace="http://docs.oasis-open.org/ns/icom/calendar/201008")
...
public class FreeBusyInterval {
	...
	/**
	 * @$clientQualifier freeBusyType
	 * @associates FreeBusyType
	 * @clientNavigability NAVIGABLE
	 */
	@XmlElement(type=FreeBusyTypeEnum.class)
