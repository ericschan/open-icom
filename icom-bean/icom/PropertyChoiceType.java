...
@XmlType(name="PropertyChoiceType", namespace="http://docs.oasis-open.org/ns/icom/metadata/201008")
...
public class PropertyChoiceType {
	...
	public PropertyChoiceType(String displayName, Object value) {
	...
	public PropertyChoiceType clone() {
		PropertyChoiceType clone;
		try {
            clone = (PropertyChoiceType) this.getClass().newInstance();
