...
@XmlType(name="Property", namespace="http://docs.oasis-open.org/ns/icom/metadata/201008")
...
public class Property {
	...
	public Property(PropertyDefinition propertyDefinition, Object value) {
		this.propertyDefinition = propertyDefinition;
		this.value = value;
	}
	...
	public Property clone() {
		Property clone;
		try {
            clone = (Property) this.getClass().newInstance();
		...
		clone.propertyDefinition = propertyDefinition;
		clone.value = value;
		return clone;
	}
