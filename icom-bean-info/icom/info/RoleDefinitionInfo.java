...
public class RoleDefinitionInfo extends ClassDefinitionInfo {

	static RoleDefinitionInfo singleton = new RoleDefinitionInfo();
	
	public static RoleDefinitionInfo getInstance() {
		return singleton;
	}
	...
	
	{
		...
		referencedObjects.add(Attributes.privileges.name());
	...
	protected RoleDefinitionInfo() {
	}
	
	public int getClassOrdinal() {
		return IcomBeanEnumeration.RoleDefinition.ordinal();
	}
