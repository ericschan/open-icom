...
public class PersonContactInfo extends ArtifactInfo implements AddressableInfo {

	static PersonContactInfo singleton = new PersonContactInfo();
	
	public static PersonContactInfo getInstance() {
		return singleton;
	}
	...
	protected PersonContactInfo() {	
	}
	
	public int getClassOrdinal() {
		return IcomBeanEnumeration.PersonContact.ordinal();
	}
	
	{
		referencedObjects.add(Attributes.bookmark.name());
		...
		referencedObjects.add(PersonalInfo.Attributes.nicknames.name());
