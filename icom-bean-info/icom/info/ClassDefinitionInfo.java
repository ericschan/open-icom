...
public class ClassDefinitionInfo extends EntityInfo implements RelationshipBondableInfo {
	
	static ClassDefinitionInfo singleton = new ClassDefinitionInfo();
	
	public static ClassDefinitionInfo getInstance() {
		return singleton;
	}
	...
	protected ClassDefinitionInfo() {	
	}
	
	public int getClassOrdinal() {
		return IcomBeanEnumeration.ClassDefinition.ordinal();
	}
