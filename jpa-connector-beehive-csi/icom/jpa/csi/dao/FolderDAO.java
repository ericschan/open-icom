...
import oracle.csi.updaters.FolderUpdater;
...
public abstract class FolderDAO extends ArtifactDAO {
	...
	public void copyObjectState(ManagedObjectProxy obj, Object csiEntity, Projection proj) {
		...
		Folder csiFolder = (Folder) csiEntity;
		...
		if (!isPartOfProjection(ArtifactInfo.Attributes.description.name(), lastLoadedProjection) &&
			...
			try {
				assignAttributeValue(pojoIdentifiable, ArtifactInfo.Attributes.description.name(), csiFolder.getDescription());
