...
public class UnknownIdentifiableDAO extends CsiIdentifiableDAO {
	
	static UnknownIdentifiableDAO singleton = new UnknownIdentifiableDAO();
	
	public static UnknownIdentifiableDAO getInstance() {
		return singleton;
	}
	
	protected UnknownIdentifiableDAO() {
	}
