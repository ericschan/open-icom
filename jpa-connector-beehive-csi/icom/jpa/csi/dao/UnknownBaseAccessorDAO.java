...
public class UnknownBaseAccessorDAO extends BaseAccessorDAO {

	static UnknownBaseAccessorDAO singleton = new UnknownBaseAccessorDAO();
	
	public static UnknownBaseAccessorDAO getInstance() {
		return singleton;
	}

	protected UnknownBaseAccessorDAO() {
	}
