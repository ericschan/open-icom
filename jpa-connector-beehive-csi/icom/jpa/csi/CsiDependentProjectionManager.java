...
public class CsiDependentProjectionManager extends DependentProjectionManager implements CsiProjectionManager {
	
	public CsiDependentProjectionManager() {
		super();
	}
	
	CsiAbstractDAO getDAO() {
		return (CsiIdentifiableDAO) dao;
	}
	...
	public Projection getLastLoadedProjection(ManagedObjectProxy proxy) {
		...
		CsiProjectionManager csiParentProjectionManager = (CsiProjectionManager) dependentProxy.getParent().getProviderProxy();
		return csiParentProjectionManager.getLastLoadedProjection(parentProxy);
	}
