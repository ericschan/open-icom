...
import oracle.csi.filters.TeamWorkspaceListFilter;

public class TeamWorkspacePredicateFactory extends BaseWorkspacePredicateFactory {
	
	static TeamWorkspacePredicateFactory singleton = new TeamWorkspacePredicateFactory();
	
	public static TeamWorkspacePredicateFactory getInstance() {
		return singleton;
	}
	
	public TeamWorkspacePredicateFactory() {
		controlClassName = "oracle.csi.controls.WorkspaceControl";
		factoryClassName = "oracle.csi.controls.WorkspaceFactory";
		listFilterCreateMethodName = "createTeamWorkspaceListFilter";
		listMethodName = "listMyTeamWorkspaces";
		listFilter = "oracle.csi.filters.TeamWorkspaceListFilter";
	}
	...
	public Class<? extends Object>[] getMethodSignatureForListMethod(ListFilter listFilter, CsiQueryContext context) {
		...
		args[0] = TeamWorkspaceListFilter.class;
		return args;
	}
