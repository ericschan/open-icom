...
import oracle.csi.filters.CategoryListFilter;
import oracle.csi.filters.ListFilter;

public class CategoryPredicateFactory extends ArtifactPredicateFactory {
	
	{
		attributeTypeMapper.put("Entities".toLowerCase(), Entity.class);
	}
		
	static CategoryPredicateFactory singleton = new CategoryPredicateFactory();
	
	public static CategoryPredicateFactory getInstance() {
		return singleton;
	}
	
	public CategoryPredicateFactory() {
		controlClassName = "oracle.csi.controls.CategoryControl";
		factoryClassName = "oracle.csi.controls.CategoryFactory";
		listFilterCreateMethodName = "createCategoryListFilter";
		listMethodName = "listCategories";
		listFilter = "oracle.csi.filters.CategoryListFilter";
	}
	...
	public Class<?>[] getArgumentsForListMethod(ListFilter listFilter, IdentifiableHandle container) {
		...
		args[0] = CategoryListFilter.class;
		return args;
	}
